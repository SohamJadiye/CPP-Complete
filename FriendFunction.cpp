...
//Below line means that non member - sumComplex function is allowed to 
//do anything with my private members
...
2.Since it is not in scope of the class, it cannot be called from 
